                               ...
                               <div class='card-body'>
                                 ...
                                 while($row = mysqli_fetch_array($run_query2)){
                                   ...
                                   if($newtype_id==$type_id){
                                    ...
                                    <div class='destination'>
                                        <a href='#' class='img img-2 d-flex justify-content-center align-items-center' style='background-image: url(includes/$img_link);'>
                                        ...
                                        <div class='text p-3'>
                                            ...
                                            if ($capa > 0) {
                                                echo "<p style='color:green ;'>$capa Tickets Available</p>";
                                            } else {
                                                echo "<p style='color: red;'>0 Tickets available</p>";
                                            }
                                
                                echo        "<p>Grab Your seats now..!</p>
                                            <hr>
                                            <p class='bottom-area d-flex'>
                                                <a href='preview.php?event_id=$event_id'>
                                                    <span><i class='icon-map-o'></i> preview</span>
                                                </a>
                                                <div>";
                                
                                                // Display booking button or house full message
                                                if ($capa > 0) {
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/bg_1.jpg);">
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
            <h2 class="mb-4">Our Speciality</h2>
            <span class="subheading">More than 100  Colleges hosted</span>
          </div>
        </div>
...
<div class="user-img mb-5" style="background-image: url(https://www.evento.infinityfreeapp.com/includes/priya2018%20.jpg)">
		                  ...
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Dr.Priya S is currently working as a Professor & HOD, Dept. of Computer Science and Engineering . Her research and professional career spans about 27 years of Teaching & research. Her expertise is primarily in the domains of Computer Networks, Operating Systems, Network Security, Digital Image Processing ,
Computer Architecture, IoT, Soft Computing and Machine Learning..</p>
		                    <p class="name">Dr.Priya S</p>
		              ...
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  <div class="user-img mb-5" style="background-image: url(https://www.evento.infinityfreeapp.com/includes/jvl1.jpg)">
		                    <span class="quote d-flex align-items-center justify-content-center">
		                      <i class="icon-quote-left"></i>
		                    </span>
		                  </div>
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Dr. Jaya V L, is working as a professor and principal .Her research and professional career spans about 17 years of Teaching & research. .</p>
		                    <p class="name">Dr. Jaya V L</p>
		                    <span class="position">Professor & Principal</span>
		                  </div>
		                </div>
		              </div>
		            </div>
...
.btn-book-container {
    ...
    margin-right: 1000px; /* Adjust the bottom margin as needed */
}
