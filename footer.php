      ...
      <div class="container">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text"> College of Engineering
                       Cherthala, Ottappuna,
                       Alappuzha,  560 074,
                        Kerala, India. </span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 9995226831</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">ebinbenny@gmail.com.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://www.cecregistration.wuaze.com" target="_blank">RRCE CSE</a>
  </p>
          </div>
        </div>
      </div>
